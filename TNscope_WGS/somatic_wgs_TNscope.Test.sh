#!/bin/sh
#SBATCH --job-name=WL-TNscope-Test
...
TUMOR_SM="Test-T" #sample name
TUMOR_RGID="rg_$TUMOR_SM" #read group ID
NORMAL_SM="Test-N" #sample name
NORMAL_RGID="rg_$NORMAL_SM" #read group ID
# PL="ILLUMINA" #or other sequencing platform
PL=DNBSEQ
FASTQ_FOLDER=/project/TumorNormal-test/Test_test_data
TUMOR_FASTQ_1=$FASTQ_FOLDER/Test-WGS-T_1.fq.gz
TUMOR_FASTQ_2=$FASTQ_FOLDER/Test-WGS-T_2.fq.gz
NORMAL_FASTQ_1=$FASTQ_FOLDER/Test-WGS-N.gDNA_1.fq.gz
NORMAL_FASTQ_2=$FASTQ_FOLDER/Test-WGS-N.gDNA_2.fq.gz
