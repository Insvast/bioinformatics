#!/bin/sh
#SBATCH --job-name=WL-TNscope-HG008
...
export SENTIEON_LICENSE=IP:8091 #or using licsrvr: c1n11.sentieon.com:5443，or /home/Licenses/Sentieon.lic
export LD_PRELOAD=/miniconda3/envs/anasys/lib/libjemalloc.so.2
export PATH=$SENTIEON_INSTALL_DIR/bin:$PATH


# Update with the fullpath location of your sample fastq
TUMOR_SM="HG008-T" #sample name
TUMOR_RGID="rg_$TUMOR_SM" #read group ID
NORMAL_SM="HG008-N" #sample name
NORMAL_RGID="rg_$NORMAL_SM" #read group ID
PL="ILLUMINA" #or other sequencing platform
FASTQ_FOLDER="/project/TumorNormal-test/data"
TUMOR_FASTQ_1="$FASTQ_FOLDER/HG008-T_Illumina_R1.fastq.gz"
TUMOR_FASTQ_2="$FASTQ_FOLDER/HG008-T_Illumina_R2.fastq.gz" #If using Illumina paired data
NORMAL_FASTQ_1="$FASTQ_FOLDER/HG008-N_Illumina_R1.fastq.gz"
NORMAL_FASTQ_2="$FASTQ_FOLDER/HG008-N_Illumina_R2.fastq.gz" #If using Illumina paired data

# Update with the location of the reference data files
FASTA_DIR="/reference/human/pangemone"
FASTA="$FASTA_DIR/hg38_ucsc.fa"
KNOWN_DBSNP="$FASTA_DIR/Homo_sapiens_assembly38.dbsnp138.vcf.gz"
PON=  # the TNscope panel-of-normals VCF, 没有就设置为空
...
BCFTOOLS_BINARY="/miniconda3/envs/anasys/bin/bcftools" #bcftools >=1.7 is recommended
MIN_QUAL=10
